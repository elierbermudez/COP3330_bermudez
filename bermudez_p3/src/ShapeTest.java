...
class ShapeTest {
    ...
    public void testTriangleArea2(){
        ...
        //The extra .001 at the end here is rounding so that you don't get funny mistakes due to doubles
        assertEquals(0.063, shape.getArea(), .001);
    }
    ...
    public void testCircleArea(){
        Shape shape = new Circle(10);
        assertEquals(314.16, shape.getArea(), .001);
    }

    @Test
    public void testCircleArea2(){
        Shape shape = new Circle(0.5);
        assertEquals(0.79, shape.getArea(), .01);
    }
    ...
    public void testSphereVolume2(){
        ...
        assertEquals(.9, shape.getVolume(), .1);
    }
